...
export default class NavigationView extends View {
    ...
    onLeftButtonClicked = (event) => {
        this.notifyAll(new Event(NavigationView.EVENT_LEFT_BUTTON_CLICKED, this, event));
    }

    onRightButtonClicked = (event) => {
        this.notifyAll(new Event(NavigationView.EVENT_RIGHT_BUTTON_CLICKED, this, event));
    }

    _render() {
        this.$template = document.querySelector("#navigation").content.cloneNode(true);
